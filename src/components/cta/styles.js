...
export const Row = tw.div`px-8 flex items-center relative z-10 flex-col lg:flex-row text-center lg:text-left justify-center`;
...
export const Subheading = tw(SubheadingBase)`text-yellow-500 mb-4 tracking-wider`

export const LinksContainer = tw.div`mt-8 lg:mt-16 flex flex-col items-center sm:block`
