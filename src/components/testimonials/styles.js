...
export const Image = tw.img`w-20 h-20 rounded-full drop-shadow`;
export const Quote = tw.blockquote`mt-5 text-gray-600 font-medium text-xl leading-loose`;
export const Link = tw.a`inline-block text-base text-secondary-600 font-bold cursor-pointer transition duration-300 border-b-2 border-transparent hover:border-secondary-500`;
